    ...
    public static void main(String[] args)
    {
        ...
        switch(choice){
            ...
            case('m'):
                ...
                System.out.printf("\nYour weight on the Moon would be %.3f pounds\n",newweight);
                break;
            
            case('C'):
            case('c'):
                newweight=weight*(3.7/9.8);
                System.out.printf("\nYour weight on the Mercury would be %.3f pounds\n",newweight);
                break;
                
            case('V'):
            case('v'):
                newweight=weight*(8.87/9.8);
                System.out.printf("\nYour weight on the Venus would be %.3f pounds\n",newweight);
                break;
            ...
            case('u'):
                ...
                System.out.printf("\nYour weight on the Uranus would be %.3f pounds\n",newweight);
                break;
            
            case('N'):
            case('n'):
                newweight=weight*(11.15/9.8);
                System.out.printf("\nYour weight on the Neptune would be %.3f pounds\n",newweight);
                break;
            
            case('P'):
            case('p'):
                newweight=weight*(.62/9.8);
                System.out.printf("\nYour weight on the Pluto would be %.3f pounds\n",newweight);
                break;
